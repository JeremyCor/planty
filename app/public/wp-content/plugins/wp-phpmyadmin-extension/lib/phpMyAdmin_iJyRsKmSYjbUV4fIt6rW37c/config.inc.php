...
$cfg['blowfish_secret']					= ':.|@6sI8ckmcPPgQ%$E(@>x}C{{#LDwE' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_iJyRsKmSYjbUV4fIt6rW37c/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://planty.local/wp-admin/?rand=57956238&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://planty.local/wp-admin/?rand=65653125&pma_logout=1';
